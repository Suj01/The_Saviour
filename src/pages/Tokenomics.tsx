...
//       >
//         <h1 className="text-[#ED0137] text-center text-[44px] py-[60px] ">TOKENOMICS</h1>
//         <div className="flex">
//           <div className="mt-[34px]">
//             <div className=" w-[244px] h-[70px] bg-[#ED0137] rounded-3xl flex items-center justify-center ml-[168px] mb-[-35px]">
//               <p className="text-[18px] text-white font-normal text-center">
//                 Token Details
//               </p>
//             </div>
//             <div className="w-[412px] h-[306px] border-2 border-rose-500 rounded-3xl ml-[90px]">
